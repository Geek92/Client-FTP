...
public class ServerConnection {
            ...
            String command = "PASV";
                    ...
                    for (String plainServerResponse : dataresponses) {
                           ...
                           // System.out.println(plainServerResponse);
                            System.out.println(file_type +" "+file_or_directory_name);
                           
                     }
        
            /*while (!stack.isEmpty()) {            
                
                String currentFileOrDirectory = (String)stack.pop();
                
                if(!visited.contains(currentFileOrDirectory)){
                     visited.add(currentFileOrDirectory);
                     //je recupere les sous dossiers du repertoire courrant
                     command = "PASV";
                     sendCommand(command);
                     opendataConnection();
                     command = "LIST";
                     sendCommand(command);
                     plainServerResponses = printDataServerResponse();
                } 
     ...
     */
     ...
     /**
      * cette fonction permets d'afficher le nom du fichier en fonction du niveau
      * @param fileName
      * @param level 
      */
